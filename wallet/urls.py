...
from wallet.views import (WalletListAPIView, WalletCreateAPIView, WalletUpdateAPIView, WalletDestroyAPIView,
                          WalletRetrieveAPIView, TransactionListAPIView, TransactionCreateAPIView,
                          TransactionDestroyAPIView, TransactionUpdateAPIView, TransactionRetrieveAPIView,
                          CoinPurchaseRetrieveAPIView, CoinPurchaseListAPIView, CoinPurchaseCreateAPIView,
                          CoinPurchaseUpdateAPIView, CoinPurchaseDestroyAPIView)
app_name = 'wallet'
